...
<template>
  <div class="detail-page">
    ...
    <div v-if="isLoading" class="loading"><div class="spinner"></div> Caricamento dati...</div>
...
@media (max-width: 768px) { .tree-header { flex-direction: column; text-align: center; } .stat-badge { width: 100%; } .info-card { flex-direction: column; gap: 15px; text-align: center; } }
</style>