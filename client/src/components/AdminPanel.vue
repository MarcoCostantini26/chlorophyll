...
const logs = ref([]);
const showModal = ref(false); // Stato del modale
let intervalId = null;
...
.btn-trash { background: none; border: none; cursor: pointer; font-size: 1rem; padding: 0; opacity: 0.6; transition: opacity 0.2s; }
...
.modal-overlay {
  ...
  display: flex; justify-content: center; align-items: center; /* CENTRATURA */
  z-index: 9999;
...
.btn-cancel {
  background: #f1f2f6; color: #7f8c8d;
